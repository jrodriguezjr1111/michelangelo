...
Outputs:
  gnss_saddle_narrow71_nano_half.stl   (print 2 copies, mirror-identical)
"""
...
BLOCK_LEN = 71.0             # X, tube-axis grip length
...
def main() -> None:
    ...
    half = build_half()
    out = OUT_DIR / "gnss_saddle_narrow71_nano_half.stl"
